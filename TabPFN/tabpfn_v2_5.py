# -*- coding: utf-8 -*-
"""tabpfn_linear_v2.5.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HasQH3Y5IV5z80-bOlRqc84vUPXFrYeD
"""
...
df = pd.DataFrame(rows)
df.to_csv(DATA_DIR / "results_rowOrder_outlier_2.csv", index=False)
df[["mae", "rmse", "mape"]].describe().to_csv(DATA_DIR / "summary_statistics_rowOrder_outlier_2.csv")
...
df = pd.DataFrame(rows)
df.to_csv(DATA_DIR / "results_rowOrder_outlier_fewshot10_2.csv", index=False)
df[["mae", "rmse", "mape"]].describe().to_csv(DATA_DIR / "summary_statistics_rowOrder_outlier_fewshot10_2.csv")
...
df = pd.DataFrame(rows)
df.to_csv(DATA_DIR / "results_rowOrder_outlier_fewshot20_2.csv", index=False)
df[["mae", "rmse", "mape"]].describe().to_csv(DATA_DIR / "summary_statistics_rowOrder_outlier_fewshot20_2.csv")
...
df = pd.DataFrame(rows)
df.to_csv(DATA_DIR / "results_rowOrder_outlier_fewshot500_2.csv", index=False)
df[["mae", "rmse", "mape"]].describe().to_csv(DATA_DIR / "summary_statistics_rowOrder_outlier_fewshot500_2.csv")
